...
<html lang="en" data-bs-theme="auto">
  <head><script src="vistas/footer/color-modes.js"></script>
...
<div class="container">
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <div class="col-md-4 d-flex align-items-center">
      ...
      <span class="mb-3 mb-md-0 text-body-secondary">&copy; HappyPet</span>
    </div>
...
<script src="vistas/footer/bootstrap.bundle.min.js"></script>
